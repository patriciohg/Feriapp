...
<head>
    ...
    <title>Ezmart Buy - Registro vendedor</title>
            ...
            <div class="col-lg-7">
                <div class="p-5">
                    <div class="text-center">
                        <h1 class="h4 text-gray-900 mb-4">Añade tu tienda a nuestra plataforma!</h1>
                    </div>
                    ...
                    <?php endif; ?>
                    <form class="user" action="<?php echo base_url();?>register/register_tienda" method="post">
                        ...
                        <hr>
                        <div class="text-center">
                        <h1 class="h5 text-gray-900 mb-4">Datos de la tienda</h1>
                        </div>
                        <div class="form-group">
                            
                        <input type="text" class="form-control form-control-user" id=""
                            placeholder="Nombre de la tienda" name="nombre_tienda">
                        </div>
                        <div class="form-group">
                            <textarea type="text" class="form-control form-control-user" id=""
                                placeholder="Describenos tu tienda, que productos ofreces y cual es tu objetivo" name="descripcion_tienda"></textarea>
                        </div>
                        
                        <hr>
                        <div class="text-center">
                        <h1 class="h5 text-gray-900 mb-4">Dirección de la tienda</h1>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
