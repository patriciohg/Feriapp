...
<head>
    ...
    <title>Ezmart Buy - Registro</title>
            ...
            <div class="col-lg-7">
                <div class="p-5">
                    <div class="text-center">
                        <h1 class="h4 text-gray-900 mb-4">Crea una cuenta en nuestra plataforma!</h1>
                    </div>
                    ...
                    <form class="user" action="<?php echo base_url();?>register/register" method="post">
                        ...
                        <hr>
                        <div class="text-center">
                        <h1 class="h5 text-gray-900 mb-4">Dirección</h1>
                        </div>
                        <div class="form-group row">
							<div class="col-sm-6 mb-3 mb-sm-0">
								<label for="calle">Calle</label>
								<input type="text" class="form-control form-control-user" id="" placeholder="Calle" name="calle" >
                            </div>
                            <div class="col-sm-6">
