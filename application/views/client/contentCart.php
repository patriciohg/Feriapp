...
<main class="mt-3 pt-4">
	<div class="container mt-5">
		<h5 class="h1 font-weight-bold text-center pt-5 pb-5">Carrito</h5>
								...
								<tbody>
									...
									<tr>
										...
										<td class="text-center">
											<a href="<?php echo base_url()."remove/".$items['rowid']."/".$items['qty'];?>" type="button" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Remove item">X</a>
										</td>
									</tr>
									<?php endforeach;?>
									<!-- /.First row -->
									...
									<tr>
										<td class="text-left">
											<a href="<?php echo site_url('/'); ?>" type="button" class="btn btn-success btn-rounded">Seguir Comprando
												<i class="fas fa-angle-left left"></i>
											</a>
										</td>
										<td class="text-left">
											<a href="<?php echo base_url();?>reiniciarCarro" class="btn btn-danger btn-remove">Vaciar Todo <span class="fa fa-trash-alt"></span></a>
										</td>
										<td colspan="3"></td>
										<td>
											<h4 class="mt-2">
